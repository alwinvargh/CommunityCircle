 ...
 *
 * @description If the email domain of the user's email is "mod.communitycircle.com", the user will be
...
const addUser = async (req, res, next) => {
  ...
  const role = emailDomain === "mod.communitycircle.com" ? "moderator" : "general";
