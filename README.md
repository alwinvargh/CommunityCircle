...
CommunityCircle is an interactive social platform designed to connect people, foster creative expression, and build vibrant online communities. It offers a variety of features such as posting, saving content, commenting, and following other users and communities, allowing for a dynamic and engaging user experience. With CommunityCircle, users can post photos, share videos, and comment on others' content while building meaningful connections.

![UI-community][https://github.com/alwinvargh/node-projects/blob/00300df4d7246bf91ad27a59da5b908c0abfd411/CommunityCircle/img/Screenshot%20(156).png]
...
1. Downld the folder CommunityCircle and Go to the project directory and install dependencies for both the client and server
...
Moderators have specific email domain (`@mod.communitycircle.com`). When registering with an email from this domain, the user is automatically assigned the moderator role. Moderators can be assigned to different communities from the admin dashboard.
## License
